...
export default function MeuPainel(){
 ...
 <section className="studentPanel"><div><span className="eyebrow">ACOMPANHAMENTO</span><h2>Seu ciclo de preparação</h2></div><div className="cycleSteps"><div className="cycle active"><b>1</b><span>Aula</span></div><i></i><div className="cycle"><b>2</b><span>Estudo</span></div><i></i><div className="cycle"><b>3</b><span>Consolidação</span></div></div></section>
